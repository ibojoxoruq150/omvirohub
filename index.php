...
<body class="main-container-xyz789">
    ...
    <script>
        ...
        window.onclick = function(event) {
            if (event.target.classList.contains('modal-overlay-zab012')) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const cards = document.querySelectorAll('.story-card-nop012, .specialty-item-opq789, .review-card-abc901');
            cards.forEach(card => {
